...
```{r}
download.file(url = "https://raw.githubusercontent.com/BiologicalDataAnalysis2019/2021/master/vignettes/HomeworkTwo.Rmd", destfile = "/cloud/project/homeworks/HW2.Rmd")
```
