...
```{r, eval=FALSE}
download.file(url = "https://raw.githubusercontent.com/BiologicalDataAnalysis2019/2024/main/data/surveys.csv", destfile = "/cloud/project/homeworks/surveys.csv")
```

Also, download the homework. 
```{r, eval=FALSE}
download.file(url = "https://raw.githubusercontent.com/BiologicalDataAnalysis2019/2024/main/vignettes/homework_2.Rmd", destfile = "/cloud/project/homeworks/homework_2.Rmd")
```
