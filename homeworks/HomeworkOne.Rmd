...
# Homework One: Due Sept. 24 at 5 pm.
...
- If your data are saved in Excel format, under the File menu in Excel, Save As -> csv. To keep it simple for now, if you have multiple worksheets in your Excel file, just pick a single one for now. Upload it to your RStudio Cloud and save in the data folder.

- Read it in with read.csv. Are the types of the columns appropriate?
